...
const Location = (props) => {
  ...
  const key = "7915ef102f460c8b9b4ec22016f56c43";
  ...
  return isLoading ? (
    ...
    <>
      <div className="location-container">
        ...
        <div className="days-button-container">
          ...
          <button onClick={sevenDayApiButton}>
            {showForecastComponent ? <FaArrowUp /> : 'Next 7 days'}
          </button>
        </div>
      ...
      <ThreeDaysForecast sevenDayTemp={sevenDayTemp} today={new Date().getDate()} />
      {/* Only display when clicking on forecast button */}
      {showForecastComponent && (
          <>
          <SevenDaysForecast location={props.location} sevenDayTemp={sevenDayTemp} />
